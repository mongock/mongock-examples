...
import com.github.cloudyrock.mongock.examples.StandaloneSpringDataAdvancedApp;
...
@Document(collection = StandaloneSpringDataAdvancedApp.CLIENTS_COLLECTION_NAME)
@CompoundIndexes({
