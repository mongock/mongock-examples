...
import io.mongock.professional.examples.SpringBootSpringDataBuilderMultitenantApp;
...
@Document(collection = SpringBootSpringDataBuilderMultitenantApp.CLIENTS_COLLECTION_NAME)
@CompoundIndexes({
