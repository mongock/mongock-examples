...
public class ClientInitializerChange {
    ...
    public void beforeExecution(MongoDatabase mongoDatabase) {
        ...
        mongoDatabase.createCollection(SpringbootReactiveApp.CLIENTS_COLLECTION_NAME).subscribe(subscriber);
        subscriber.await();
    }
    ...
    public void rollbackBeforeExecution(MongoDatabase mongoDatabase) {
        SubscriberSync<Void> subscriber = new MongoSubscriberSync<>();
        mongoDatabase.getCollection(SpringbootReactiveApp.CLIENTS_COLLECTION_NAME).drop().subscribe(subscriber);
        subscriber.await();
    }
    ...
    public void execution(ClientSession clientSession, MongoDatabase mongoDatabase) {
        ...
        mongoDatabase.getCollection(SpringbootReactiveApp.CLIENTS_COLLECTION_NAME, Client.class)
    ...
    public void rollbackExecution(ClientSession clientSession, MongoDatabase mongoDatabase) {
        ...
        mongoDatabase
                .getCollection(SpringbootReactiveApp.CLIENTS_COLLECTION_NAME, Client.class)
